...
public class ServerResponse<T> implements Serializable {
    ...
    public static <T> ServerResponse<T> createByIllegalArgumentMessage(String errorMessage){
    ...
    public static <T> ServerResponse<T> createByNeedLoginMessage(String errorMessage){
